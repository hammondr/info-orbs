...
// This takes the text output form the weather API and maps it to a respective icon/byte array, then displays it,
...
// doesn't round deg, just removes all text after the decimal, should prob be fixed
